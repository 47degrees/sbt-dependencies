...
package object dependencies {
  ...
  implicit val ghResponseMonad: Monad[Github4sResponse] =
    new Monad[Github4sResponse] {
      ...
      override def pure[A](x: A): Github4sResponse[A] =
        EitherT.pure(GHResult(x, 200, Map.empty))
    }
